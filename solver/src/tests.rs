pub mod tests {
    ...
    #[test]
    fn test_grain_calc() {
        use crate::entity::grain::{Calc, Grain};
        ...
        let mut electrons: Grain<Vec2d> = Grain::<Vec2d>::new(
            ...
            vec![vec![1.60217662e-19f64], vec![1.60217662e-19f64]],
            vec![9.10938356e-31f64],
        );
    ...
    fn test_geo_plain() {
        ...
        assert_eq!(
            t2d.is_inside(&Point::<Vec2d>::new(Vec2d::new(0.0f64, 0.0f64)), &acc),
            true
        );
        assert_eq!(
            t2d.is_inside(&Point::<Vec2d>::new(Vec2d::new(-1.0f64, 0.5f64)), &acc),
            false
        );
    ...
    fn test_geo_ops() {
        ...
        assert_eq!(
            t3d.is_inside(
                &Point::<Vec3d>::new(Vec3d::new(0.0f64, 0.0f64, 0.1f64)),
                &acc
            ),
            false
        );
        ...
        assert_eq!(
            format!("{}", t3d.normal()),
            "0.9761870601839527\t0\t0.21693045781865616"
        );
    }
}
